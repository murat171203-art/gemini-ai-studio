...
export const translations: Record<Language, TranslationKeys> = {
  ky: {
    ...
    steps: {
      ...
      step2Title: "Анализ жана текшерүү",
      step2Desc: "AI анализдеп, суу белги менен студентке текшертүүгө берет",
      step3Title: "Төлөм",
      step3Desc: "Натыйжа жакса, MBank аркылуу төлөм жасаңыз",
      step4Title: "Жүктөп алуу",
      step4Desc: "Суу белгисиз таза файлды Word же PDF форматында алыңыз",
    },
    features: {
      title: "Артыкчылыктар",
      ai: "AI технологиясы",
  ...
  tr: {
    ...
    steps: {
      ...
      step2Title: "Analiz ve İnceleme",
      step2Desc: "AI analiz eder, filigranla öğrenciye inceleme için sunar",
      step3Title: "Ödeme",
      step3Desc: "Sonuç beğenildiyse MBank ile ödeme yapın",
      step4Title: "İndirme",
      step4Desc: "Filigransız temiz dosyayı Word veya PDF olarak indirin",
    },
    features: {
      title: "Avantajlar",
      ai: "AI Teknolojisi",
  ...
  ru: {
    ...
    steps: {
      ...
      step2Title: "Анализ и проверка",
      step2Desc: "AI анализирует и выдаёт результат с водяным знаком для проверки",
      step3Title: "Оплата",
      step3Desc: "Если результат устраивает, оплатите через MBank",
      step4Title: "Скачивание",
      step4Desc: "Скачайте чистый файл без водяного знака в Word или PDF",
    },
    features: {
      title: "Преимущества",
      ai: "Технология AI",
  ...
  en: {
    ...
    steps: {
      ...
      step2Title: "Analysis & Review",
      step2Desc: "AI analyzes and provides a watermarked preview for review",
      step3Title: "Payment",
      step3Desc: "If satisfied, pay via MBank",
      step4Title: "Download",
      step4Desc: "Download the clean file without watermark in Word or PDF",
    },
    features: {
      title: "Advantages",
      ai: "AI Technology",
